 ...
 */
public class RgbHistogram_19527704_AguileraGonzalez extends Histogram_19527704_AguileraGonzalez {
    
    private ArrayList<int[]> rgbColorList;
     ...
     */
    public RgbHistogram_19527704_AguileraGonzalez(ArrayList<int[]> rgbColorList, ArrayList<Integer> freqList) {
        super(freqList);
