 ...
 */
public class Bitmap_19527704_AguileraGonzalez extends Image_19527704_AguileraGonzalez {
     ...
     */
    public Bitmap_19527704_AguileraGonzalez(int width, int height, ArrayList<Pixel_19527704_AguileraGonzalez> pixlist) {
